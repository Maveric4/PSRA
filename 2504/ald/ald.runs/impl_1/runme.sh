...
HD_PWD='/home/lsriw/HSVS/1104_copy/ald/ald.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ald_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ald_wrapper.tcl -notrace
