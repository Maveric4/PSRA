...
################################################################
# This is a generated script based on design: ald
#
...
proc create_root_design { parentCell } {
  ...
  set shift_reg_0 [ create_bd_cell -type ip -vlnv user.org:user:shift_reg:1.0 shift_reg_0 ]

  # Create instance: shift_reg_1, and set properties
  set shift_reg_1 [ create_bd_cell -type ip -vlnv user.org:user:shift_reg:1.0 shift_reg_1 ]
  ...
  # Create instance: write_video_bram_0, and set properties
  set write_video_bram_0 [ create_bd_cell -type ip -vlnv user.org:user:write_video_bram:1.0 write_video_bram_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins parameter_register_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net GND_dout [get_bd_ports hdmi_out_en] [get_bd_pins GND/dout] [get_bd_pins clk_wiz_0/reset] [get_bd_pins dvi2rgb_0/aRst] [get_bd_pins dvi2rgb_0/pRst]
  connect_bd_net -net VCC_dout [get_bd_ports hdmi_hpd] [get_bd_pins VCC/dout] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/det_clken] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_tc_0/s_axi_aclken] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/axis_enable] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_pins axi_bram_ctrl_0/bram_addr_a] [get_bd_pins shift_reg_1/addr_in]
  ...
  connect_bd_net -net draw_bbox_0_de_out [get_bd_pins draw_bbox_0/de_out] [get_bd_pins rgb2vga_0/rgb_pVDE]
  connect_bd_net -net draw_bbox_0_hsync_out [get_bd_pins draw_bbox_0/hsync_out] [get_bd_pins rgb2vga_0/rgb_pHSync]
  connect_bd_net -net draw_bbox_0_rgb_out [get_bd_pins draw_bbox_0/rgb_out] [get_bd_pins rgb2vga_0/rgb_pData]
  connect_bd_net -net draw_bbox_0_vsync_out [get_bd_pins draw_bbox_0/vsync_out] [get_bd_pins rgb2vga_0/rgb_pVSync]
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins draw_bbox_0/clk] [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins rgb2vga_0/PixelClk] [get_bd_pins system_ila_0/clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins write_video_bram_0/clk]
  connect_bd_net -net parameter_register_0_bbox0 [get_bd_pins draw_bbox_0/bbox_0] [get_bd_pins parameter_register_0/bbox0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins parameter_register_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins v_tc_0/s_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins parameter_register_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  connect_bd_net -net shift_reg_1_addr_out [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins shift_reg_1/addr_out]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins parameter_register_0/sw]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net v_axi4s_vid_out_0_overflow [get_bd_pins v_axi4s_vid_out_0/overflow] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net v_axi4s_vid_out_0_underflow [get_bd_pins v_axi4s_vid_out_0/underflow] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins draw_bbox_0/de_in] [get_bd_pins v_axi4s_vid_out_0/vid_active_video] [get_bd_pins write_video_bram_0/de_in]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins draw_bbox_0/rgb_in] [get_bd_pins v_axi4s_vid_out_0/vid_data] [get_bd_pins write_video_bram_0/rgb_in]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins draw_bbox_0/hsync_in] [get_bd_pins v_axi4s_vid_out_0/vid_hsync] [get_bd_pins write_video_bram_0/hsync_in]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins draw_bbox_0/vsync_in] [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins v_axi4s_vid_out_0/vid_vsync] [get_bd_pins write_video_bram_0/vsync_in]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net v_vid_in_axi4s_0_overflow [get_bd_pins v_vid_in_axi4s_0/overflow] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net v_vid_in_axi4s_0_underflow [get_bd_pins v_vid_in_axi4s_0/underflow] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net write_video_bram_0_addrb [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins system_ila_0/probe0] [get_bd_pins write_video_bram_0/addrb]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets write_video_bram_0_addrb]
  connect_bd_net -net write_video_bram_0_dinb [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins system_ila_0/probe1] [get_bd_pins write_video_bram_0/dinb]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets write_video_bram_0_dinb]
  connect_bd_net -net write_video_bram_0_enb [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins write_video_bram_0/enb]
  connect_bd_net -net write_video_bram_0_web [get_bd_pins blk_mem_gen_0/web] [get_bd_pins system_ila_0/probe2] [get_bd_pins write_video_bram_0/web]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets write_video_bram_0_web]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs parameter_register_0/S00_AXI/S00_AXI_reg] SEG_parameter_register_0_S00_AXI_reg
