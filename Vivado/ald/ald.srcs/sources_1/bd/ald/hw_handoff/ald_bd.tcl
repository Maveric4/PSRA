...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net GND_dout [get_bd_ports hdmi_out_en] [get_bd_pins GND/dout] [get_bd_pins clk_wiz_1/reset] [get_bd_pins dvi2rgb_0/aRst] [get_bd_pins dvi2rgb_0/pRst]
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_pins axi_bram_ctrl_0/bram_addr_a] [get_bd_pins shift_addr_0/addr_in]
  ...
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins dvi2rgb_0/RefClk]
  ...
  connect_bd_net -net shift_addr_0_addr_out [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins shift_addr_0/addr_out]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins parameter_register_0/sw]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net v_axi4s_vid_out_0_overflow [get_bd_pins v_axi4s_vid_out_0/overflow] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net v_axi4s_vid_out_0_underflow [get_bd_pins v_axi4s_vid_out_0/underflow] [get_bd_pins xlconcat_0/In3]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins draw_bbox_0/vsync_in] [get_bd_pins v_axi4s_vid_out_0/vid_vsync] [get_bd_pins write_video_bram_0/vsync_in]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net v_vid_in_axi4s_0_overflow [get_bd_pins v_vid_in_axi4s_0/overflow] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net v_vid_in_axi4s_0_underflow [get_bd_pins v_vid_in_axi4s_0/underflow] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net write_video_bram_0_addra [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins system_ila_0/probe0] [get_bd_pins write_video_bram_0/addra]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets write_video_bram_0_addra]
  connect_bd_net -net write_video_bram_0_dina [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins system_ila_0/probe1] [get_bd_pins write_video_bram_0/dina]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets write_video_bram_0_dina]
  connect_bd_net -net write_video_bram_0_ena [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins system_ila_0/probe3] [get_bd_pins write_video_bram_0/ena]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets write_video_bram_0_ena]
  connect_bd_net -net write_video_bram_0_wea [get_bd_pins blk_mem_gen_0/web] [get_bd_pins system_ila_0/probe2] [get_bd_pins write_video_bram_0/wea]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets write_video_bram_0_wea]
