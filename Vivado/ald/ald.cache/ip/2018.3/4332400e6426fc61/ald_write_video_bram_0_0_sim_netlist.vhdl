...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_write_video_bram is
  ...
  attribute SOFT_HLUTNM of \r_frameH[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \r_frameH[2]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \r_frameW[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \r_frameW[7]_i_1\ : label is "soft_lutpair6";
...
\addr[11]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
