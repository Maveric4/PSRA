...
HD_PWD='/home/lsriw/PSRA/DG/lab5/ald/ald.runs/ald_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ald_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ald_axi_bram_ctrl_0_0.tcl
