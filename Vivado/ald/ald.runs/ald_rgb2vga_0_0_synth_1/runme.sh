...
HD_PWD='/home/tomasz/skrypty/skrypt_psra/solution/ald/ald.runs/ald_rgb2vga_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ald_rgb2vga_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ald_rgb2vga_0_0.tcl
