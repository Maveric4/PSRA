...
HD_PWD='/home/lsriw/PSRA/DG/lab4/ald/ald.runs/ald_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ald_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ald_xbar_0.tcl
