...
HD_PWD='/home/lsriw/HSVS/0404/ald_cpu_hdmi_vga/ald/ald.runs/ald_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ald_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ald_blk_mem_gen_0_0.tcl
