...
HD_PWD='/home/tomasz/fpga_zynq/zybo/base_designs/draw_bbox/draw_bbox.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log draw_bbox.vds -m64 -mode batch -messageDb vivado.pb -notrace -source draw_bbox.tcl
